...
public class Graph{
    ...
    public List<Vertex> getVertices(){
        ...
        //COMPLETE 1: Liste kopieren und zurÃ¼ckgeben.
    ...
    public List<Edge> getEdges(){
        ...
        //COMPLETE 2: Liste kopieren und zurueckgeben
    ...
    public Vertex getVertex(String pID){
        ...
        //COMPLETE 3: Knoten suchen und zurÃ¼ckgeben.
    ...
    public void addVertex(Vertex pVertex){
        ...
        if (pVertex != null && pVertex.getID() != null) {
            ...
            boolean freeID = getVertex(pVertex.getID()) == null;
            if(freeID){
                vertices.append(pVertex);
            }
            //COMPLETE 4: Knoten hinzufÃ¼gen
        }
    }
